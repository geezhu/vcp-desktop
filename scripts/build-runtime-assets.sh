...
manifest_version|1
artifact|node|${NODE_RUNTIME_VERSION#v}|linux-x86_64|${RELEASE_BASE_URL}/${NODE_RUNTIME_ASSET_NAME}|-|${NODE_SHA256}|-
artifact|python|${PYTHON_RUNTIME_VERSION}|linux-x86_64|${RELEASE_BASE_URL}/${PYTHON_RUNTIME_ASSET_NAME}|-|${PYTHON_SHA256}|-
EOF
